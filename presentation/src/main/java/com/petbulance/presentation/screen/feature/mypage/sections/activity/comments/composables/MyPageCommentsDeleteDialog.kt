package com.petbulance.presentation.screen.feature.mypage.sections.activity.comments.composables
...
@Composable
fun MyPageCommentsDeleteDialog(
...
@Composable
private fun MyPageCommentsDeleteDialogPreview() {
    PetbulanceTheme {
