...
class DisconnectSocialAccountUseCase @Inject constructor(
    private val repository: UserRepository
) {
    suspend operator fun invoke(provider: String): Result<SocialConnectResult> {
        return repository.disconnectSocialAccount(platform = provider)
    }
}