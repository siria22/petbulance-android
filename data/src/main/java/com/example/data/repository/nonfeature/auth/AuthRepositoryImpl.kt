package com.example.data.repository.nonfeature.auth
...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun refreshToken(refreshToken: String): Result<Pair<String?, String?>> =
        runCatching {
//            val requestDto = RefreshRequestDto(refreshToken = refreshToken)
//            return safeApiCall<RefreshResponseDto> {
//                authApi.refreshToken(requestDto)
//            }.map { responseDto ->
//                Pair(responseDto.accessToken, responseDto.refreshToken)
//            }

            return Result.success(Pair("New Access Token", "Refresh token"))
        }
